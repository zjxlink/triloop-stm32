...
/* USER CODE BEGIN 0 */
extern uint8_t USART1_RX_BUFFER[USART_RX_BUFFER_SIZE];
extern uint8_t USART2_RX_BUFFER[USART_RX_BUFFER_SIZE];
extern uint8_t USART3_RX_BUFFER[USART_RX_BUFFER_SIZE];
extern uint8_t UART4_RX_BUFFER[USART_RX_BUFFER_SIZE];
extern uint8_t USART6_RX_BUFFER[USART_RX_BUFFER_SIZE];
/* USER CODE END 0 */
...
//
    ...
    //LL_DMA_SetMemoryAddress(DMA2, LL_DMA_STREAM_2, (uint32_t)USART1_RX_BUFFER);
    //LL_DMA_SetDataLength(DMA2, LL_DMA_STREAM_2, USART_RX_BUFFER_SIZE);
